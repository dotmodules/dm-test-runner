...
setup_file() {
  ...
  echo "setup file 2 - [test suite]:    ${test_suite_level_test_directory}"
  echo "setup file 2 - [test file]:     ${test_file_level_test_directory}"
}
...
teardown_file() {
  ...
  echo "teardown file 2 - [test suite]: ${test_suite_level_test_directory}"
  echo "teardown file 2 - [test file]:  ${test_file_level_test_directory}"
}
...
setup() {
  ...
  echo "setup 2 - [test suite]:         ${test_suite_level_test_directory}"
  echo "setup 2 - [test file]:          ${test_file_level_test_directory}"
  echo "setup 2 - [test case]:          ${test_case_level_test_directory}"
}
...
teardown() {
  ...
  echo "teardown 2 - [test suite]:      ${test_suite_level_test_directory}"
  echo "teardown 2 - [test file]:       ${test_file_level_test_directory}"
  echo "teardown 2 - [test case]:       ${test_case_level_test_directory}"
}
...
test__test_directories__file_2__case_1() {
  ...
  echo "test case 2 - [test suite]:     ${test_suite_level_test_directory}"
  echo "test case 2 - [test file]:      ${test_file_level_test_directory}"
  echo "test case 2 - [test case]:      ${test_case_level_test_directory}"
}
