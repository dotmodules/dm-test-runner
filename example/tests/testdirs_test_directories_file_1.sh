...
setup_file() {
  ...
  echo "setup file 1 - [test suite]:    ${test_suite_level_test_directory}"
  echo "setup file 1 - [test file]:     ${test_file_level_test_directory}"
}
...
teardown_file() {
  ...
  echo "teardown file 1 - [test suite]: ${test_suite_level_test_directory}"
  echo "teardown file 1 - [test file]:  ${test_file_level_test_directory}"
}
...
setup() {
  ...
  echo "setup 1 - [test suite]:         ${test_suite_level_test_directory}"
  echo "setup 1 - [test file]:          ${test_file_level_test_directory}"
  echo "setup 1 - [test case]:          ${test_case_level_test_directory}"
}
...
teardown() {
  ...
  echo "teardown 1 - [test suite]:      ${test_suite_level_test_directory}"
  echo "teardown 1 - [test file]:       ${test_file_level_test_directory}"
  echo "teardown 1 - [test case]:       ${test_case_level_test_directory}"
}
...
test__test_directories__file_1__case_1() {
  ...
  echo "test case 1 - [test suite]:     ${test_suite_level_test_directory}"
  echo "test case 1 - [test file]:      ${test_file_level_test_directory}"
  echo "test case 1 - [test case]:      ${test_case_level_test_directory}"
}
