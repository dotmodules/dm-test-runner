...
setup_file() {
  ...
  posix_adapter__echo "setup file 1 - [test suite]:    ${test_suite_level_test_directory}"
  posix_adapter__echo "setup file 1 - [test file]:     ${test_file_level_test_directory}"
}
...
teardown_file() {
  ...
  posix_adapter__echo "teardown file 1 - [test suite]: ${test_suite_level_test_directory}"
  posix_adapter__echo "teardown file 1 - [test file]:  ${test_file_level_test_directory}"
}
...
setup() {
  ...
  posix_adapter__echo "setup 1 - [test suite]:         ${test_suite_level_test_directory}"
  posix_adapter__echo "setup 1 - [test file]:          ${test_file_level_test_directory}"
  posix_adapter__echo "setup 1 - [test case]:          ${test_case_level_test_directory}"
}
...
teardown() {
  ...
  posix_adapter__echo "teardown 1 - [test suite]:      ${test_suite_level_test_directory}"
  posix_adapter__echo "teardown 1 - [test file]:       ${test_file_level_test_directory}"
  posix_adapter__echo "teardown 1 - [test case]:       ${test_case_level_test_directory}"
}
...
test__test_directories__file_1__case_1() {
  ...
  posix_adapter__echo "test case 1 - [test suite]:     ${test_suite_level_test_directory}"
  posix_adapter__echo "test case 1 - [test file]:      ${test_file_level_test_directory}"
  posix_adapter__echo "test case 1 - [test case]:      ${test_case_level_test_directory}"
}
