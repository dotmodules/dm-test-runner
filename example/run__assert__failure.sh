...
POSIX_TEST__CONFIG__MANDATORY__TEST_FILE_PREFIX='test_assert__'
POSIX_TEST__CONFIG__MANDATORY__TEST_CASE_PREFIX='should_fail_'
...
posix_adapter__echo '                             _   _'
posix_adapter__echo '     /\                     | | (_)'
posix_adapter__echo '    /  \   ___ ___  ___ _ __| |_ _  ___  _ __  ___'
posix_adapter__echo '   / /\ \ / __/ __|/ _ \ '\''__| __| |/ _ \| '\''_ \/ __|'
posix_adapter__echo '  / ____ \ __ \__ \  __/ |  | |_| | (_) | | | \__ \'
posix_adapter__echo ' /_/    \_\___/___/\___|_|   \__|_|\___/|_| |_|___/'
posix_adapter__echo ''
posix_adapter__echo '==============================================================================='
posix_adapter__echo '  ASSERTION FAILURE CASES'
posix_adapter__echo '==============================================================================='
posix_adapter__echo "${RESET}"

posix_test__run_suite

assert_test_case_count 65
assert_failure_count 65
