...
POSIX_TEST__CONFIG__MANDATORY__TEST_FILE_PREFIX='test_hooks__'
...
POSIX_TEST__CONFIG__OPTIONAL__SORTED_TEST_CASE_EXECUTION=1
...
assert_test_case_count 7
assert_failure_count 5
