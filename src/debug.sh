...
#   None
# Arguments:
#   printf compatible argument interface.
# STDIN:
#   None
#------------------------------------------------------------------------------
# Output variables:
...
#   None
# Arguments:
#   Variable length arguments that will be executed as a command while having a
...
#------------------------------------------------------------------------------
# Globals:
#   DM_TEST__CONFIG__DEBUG_ENABLED
# Arguments:
#   None
# STDIN:
#   None
...
#   test
#==============================================================================
_dm_test__debug__is_enabled() {
  test "$DM_TEST__CONFIG__DEBUG_ENABLED" != '0'
}
